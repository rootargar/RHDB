...
if (isset($_POST['exportar_excel'])) {
    ...
    // Construir la consulta SQL para obtener los cursos concluidos
    // Incluye cursos que están completados y a los que el empleado asistió
    $sql = "SELECT 
                c.IdCurso, 
                c.NomCurso, 
                c.Area, 
            ...
            FROM 
                capacitaciones c
            INNER JOIN 
                plancursos p ON c.IdCurso = p.IdCurso
            INNER JOIN 
                cursoxpuesto cp ON c.IdCurso = cp.IdCurso AND c.Puesto = cp.puesto
            WHERE 
                p.Estado = 'Completado' 
                AND c.Asistio = 'Si'";
    ...
    $sql .= " ORDER BY c.Empleado, c.NomCurso";
                ...
                <div class="table-responsive">
                    <table id="tabla-cursos-concluidos" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            if (empty($empleado_seleccionado)) {
                                $sql .= "c.IdEmp, c.Empleado, c.Puesto, c.Departamento, ";
                            }
