...
if (isset($_POST['exportar_excel'])) {
    ...
    // Consulta adaptada a la nueva estructura de tablas
    $sql = "SELECT 
                c.Id, 
                c.IdEmp, 
    ...
    if ($stmt !== false) {
        ...
        // Para depuración:
        // echo '<tr><td colspan="11">Error: ' . print_r(sqlsrv_errors(), true) . '</td></tr>';
    }
                    ...
                    <table id="tabla-capacitaciones" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            if ($stmt !== false) {
                                ...
                                // Para depuración:
                                // echo '<tr><td colspan="11" class="text-center">Error: ' . print_r(sqlsrv_errors(), true) . '</td></tr>';
                            }
