...
if (isset($_POST['exportar_excel'])) {
    ...
    // Obtener los datos uniendo las tablas usuarios y puestos
    $sql = "SELECT u.Clave, u.NombreCompleto, p.puesto, u.FechaIngreso, u.Sucursal, u.usuario, 
            p.depto AS Departamento, u.correo, u.rol
            FROM usuarios u
                    ...
                    <table id="tabla-empleados" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            if ($stmt !== false) {
                                ...
                                // Mostrar error de SQL Server si existe
                                if (($errors = sqlsrv_errors()) != null) {
                                    foreach ($errors as $error) {
                                        echo '<tr><td colspan="9" class="text-danger">Error: ' . $error['message'] . '</td></tr>';
                                    }
                                }
                            }
